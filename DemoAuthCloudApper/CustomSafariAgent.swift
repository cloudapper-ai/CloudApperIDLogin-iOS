...
class OIDExternalUserAgentIOSSafariViewController: NSObject {
    var _presentingViewController: UIViewController = UIViewController()
    ...
    class func safariViewControllerFactory() -> OIDSafariViewControllerFactory {
        ...
        gSafariViewControllerFactory = OIDDefaultSafariViewControllerFactory()
